...
import {WETH_ADDRESS} from './helpers.output'
...
export function getETHPriceInUSD(): BigDecimal {
    ...
    pair = Pair.load('{{.}}')
    if (pair != null) {
        return pair.token0 == WETH_ADDRESS ? pair.token1Price : pair.token0Price
    }
    {{/StablePairs}}
...
let MINIMUM_LIQUIDITY_THRESHOLD_ETH = BigDecimal.fromString('{{LiquidityThresholdETH}}')
