...
import { convertTokenToDecimal, loadTransaction, safeDiv } from './index'
import { findEthPerToken, getEthPriceInUSD, getTrackedAmountUSD, sqrtPriceX96ToTokenPrices } from './pricing.output'
import {
  updatePoolDayData,
  updatePoolHourData,
  updateTickDayData,
  updateTokenDayData,
  updateTokenHourData,
  updatePangolinDayData
} from './intervalUpdates'
import { createTick, feeTierToTickSpacing } from './tick'
...
export function handleMint(event: MintEvent): void {
  ...
  // pool data
  pool.txCount = pool.txCount.plus(BI_1)
