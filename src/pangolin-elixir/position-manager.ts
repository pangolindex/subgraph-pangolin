...
import { convertTokenToDecimal, loadTransaction } from './index'
import { factoryContract } from './constants.output'
import { ADDRESS_ZERO, BD_0, BI_0 } from '../constants'
...
function getPosition(event: ethereum.Event, tokenId: BigInt): Position | null {
  ...
  if (position === null) {
    ...
    if (!positionCall.reverted) {
      ...
      position.depositedToken0 = BD_0
      position.depositedToken1 = BD_0
      position.withdrawnToken0 = BD_0
      position.withdrawnToken1 = BD_0
      position.collectedFeesToken0 = BD_0
      position.collectedFeesToken1 = BD_0
